...
import edu.sdsc.mmtf.spark.ml.DatasetBalancer;
import edu.sdsc.mmtf.spark.ml.SparkMultiClassClassifier;
 ...
 * 
 * Example: Demo1Classifier proteinFold.parquet foldType
 * 
 * @author Peter Rose
 *
 */
public class Demo1Classifier {

	/**
	 * @param args[0] parquet files name with feature vector, args[1] name of class label
	 * @throws IOException 
	 */
	public static void main(String[] args) throws IOException {

		if (args.length != 2) {
			System.err.println("Usage: " + Demo1Classifier.class.getSimpleName() + " <parquet file> <classification column name>");
			System.exit(1);
		}
		...
		SparkSession spark = SparkSession
				.builder()
				.master("local[*]")
				.appName(Demo1Classifier.class.getSimpleName())
				.getOrCreate();
